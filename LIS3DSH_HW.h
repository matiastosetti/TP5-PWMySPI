...
#define CS_H GPIO_SetBits(GPIOE,GPIO_Pin_3) //se debería poder pasar el número de pin y puerto como argumento. Es decir la librería ser configurable para que desde el bsp le diga que spi quiero usar. En este caso uso el puerto D pin3
...
//Máscara de sensibilidad. Configuración que se le puede dar al acelerometro
